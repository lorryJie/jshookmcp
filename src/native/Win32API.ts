...
let kernel32: koffi.LibraryHandle | null = null;
let ntdll: koffi.LibraryHandle | null = null;
let psapi: koffi.LibraryHandle | null = null;
 ...
 */
function getNtdll(): koffi.LibraryHandle {
  if (!ntdll) {
 ...
 */
function getPsapi(): koffi.LibraryHandle {
  if (!psapi) {
