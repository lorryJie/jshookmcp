...
export const referenceSidebarItems = [
  ...
  { text: 'APK 加固识别', link: '/reference/domains/apk-packer' },
  { text: '二进制插桩', link: '/reference/domains/binary-instrument' },
  { text: '二进制密钥', link: '/reference/domains/binary-secrets' },
  ...
  { text: '证据图', link: '/reference/domains/evidence' },
  ...
  { text: '共享状态板', link: '/reference/domains/shared-state-board' },
  { text: 'Skia 捕获', link: '/reference/domains/skia-capture' },
